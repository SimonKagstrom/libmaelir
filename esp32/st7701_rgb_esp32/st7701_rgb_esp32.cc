...
St7701RgbEsp32::St7701RgbEsp32(const esp_lcd_panel_io_3wire_spi_config_t& io_config,
                               const esp_lcd_rgb_panel_config_t& rgb_config)
{
    ...
    callbacks.on_bounce_empty = St7701RgbEsp32::OnBounceBufferFillStatic;
    callbacks.on_vsync = OnVsync;
    callbacks.on_frame_buf_complete = St7701RgbEsp32::OnBounceBufferFinishStatic;
...
uint16_t*
St7701RgbEsp32::GetFrameBuffer(hal::IDisplay::Owner owner)
{
...
void
St7701RgbEsp32::SetActive(bool active)
{
    m_active = active;
}
...
void IRAM_ATTR
St7701RgbEsp32::OnBounceBufferFill(void* bounce_buf, int pos_px, int len_bytes)
{
    if (m_active)
    {
...
void IRAM_ATTR
St7701RgbEsp32::OnBounceBufferFinish()
{
    if (m_flip_requested)
    {
...
bool IRAM_ATTR
St7701RgbEsp32::OnBounceBufferFinishStatic(esp_lcd_panel_handle_t panel,
